...
| Primary focus | zone composition, pluggable regions, next-generation UI assembly |
...
| Named Exports | 4 | `packageId`, `packageDisplayName`, `packageDescription`, `createNextZone` |
...
console.log(packageId, packageDisplayName, typeof createNextZone);
```

Use the root repo scripts for day-to-day work after the workspace is bootstrapped, or run the nested package directly from `framework/libraries/ui-zone-next` if you need lower-level control.
